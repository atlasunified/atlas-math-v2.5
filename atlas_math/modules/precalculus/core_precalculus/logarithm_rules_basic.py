...
MODULE_INFO = {
    "module_id": "precalculus.logarithm_rules_basic",
    "name": "Logarithm Rules Basic",
    "topic": "precalculus",
...
INSTRUCTIONS = [
    "Use logarithm properties to simplify or expand: {problem}",
    "Apply the log rules: {problem}",
    "Rewrite the logarithmic expression: {problem}",
]
...
def iter_level1_specs():
    return _emit("level_1", [
        ("product_rule", ("log_b(MN)",), "Expand log_b(MN).", "log_b(M) + log_b(N)"),
        ("quotient_rule", ("log_b(M/N)",), "Expand log_b(M/N).", "log_b(M) - log_b(N)"),
        ("power_rule", ("log_b(M^3)",), "Expand log_b(M^3).", "3log_b(M)"),
    ])

def iter_level2_specs():
    return _emit("level_2", [
        ("condense_two", ("2log(x)+log(y)",), "Condense 2log(x) + log(y) into a single logarithm.", "log(x^2y)"),
        ("condense_quotient", ("log(a)-log(b)",), "Condense log(a) - log(b) into a single logarithm.", "log(a/b)"),
        ("expand_simple", ("log((x^2y)/z)",), "Expand log((x^2y)/z).", "2log(x) + log(y) - log(z)"),
    ])

def iter_level3_specs():
    return _emit("level_3", [
        ("evaluate_common", (100,), "Evaluate log(100).", "2"),
        ("evaluate_common", (1000,), "Evaluate log(1000).", "3"),
        ("evaluate_natural", (1,), "Evaluate ln(1).", "0"),
        ("evaluate_base", (2, 32), "Evaluate log_2(32).", "5"),
    ])

def iter_level4_specs():
    return _emit("level_4", [
        ("solve_basic", ("log_3(x)=2",), "Solve log_3(x) = 2.", "x = 9"),
        ("solve_basic", ("ln(x)=3",), "Solve ln(x) = 3.", "x = e^3"),
        ("solve_basic", ("log(x)=4",), "Solve log(x) = 4.", "x = 10000"),
    ])

def iter_level5_specs():
    return _emit("level_5", [
        ("mixed_expand", ("log_5((a^3b^2)/c)",), "Expand log_5((a^3b^2)/c).", "3log_5(a) + 2log_5(b) - log_5(c)"),
        ("mixed_condense", ("3ln(x)-2ln(y)+ln(z)",), "Condense 3ln(x) - 2ln(y) + ln(z).", "ln((x^3z)/y^2)"),
    ])
