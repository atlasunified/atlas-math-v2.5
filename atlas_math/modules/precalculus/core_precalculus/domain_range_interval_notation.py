...
MODULE_INFO = {
    "module_id": "precalculus.domain_range_interval_notation",
    "name": "Domain and Range Interval Notation",
    "topic": "precalculus",
...
INSTRUCTIONS = [
    "State the domain or range in interval notation: {problem}",
    "Find the requested set in interval notation: {problem}",
    "Determine the domain or range: {problem}",
]

def _emit(level, rows):
    cap = LEVEL_SPEC_CAPS[level]
    for idx, (prompt, answer, values) in enumerate(rows):
        if idx >= cap:
            return
        yield _spec("domain_range_interval", values, prompt, answer)

def iter_level1_specs():
    return _emit("level_1", [
        ("Find the domain of f(x) = 2x + 5.", "(-∞, ∞)", ("linear", "domain")),
        ("Find the range of f(x) = 2x + 5.", "(-∞, ∞)", ("linear", "range")),
        ("Find the domain of f(x) = x^2.", "(-∞, ∞)", ("quadratic", "domain")),
    ])

def iter_level2_specs():
    return _emit("level_2", [
        ("Find the domain of f(x) = √(x - 4).", "[4, ∞)", ("sqrt", "domain", 4)),
        ("Find the range of f(x) = √(x - 4).", "[0, ∞)", ("sqrt", "range", 4)),
        ("Find the domain of f(x) = √(x + 3).", "[-3, ∞)", ("sqrt", "domain", -3)),
    ])

def iter_level3_specs():
    return _emit("level_3", [
        ("Find the domain of f(x) = 1/(x - 2).", "(-∞, 2) ∪ (2, ∞)", ("rational", "domain", 2)),
        ("Find the range of f(x) = 1/(x - 2).", "(-∞, 0) ∪ (0, ∞)", ("rational", "range", 2)),
        ("Find the domain of f(x) = 3/(x + 1).", "(-∞, -1) ∪ (-1, ∞)", ("rational", "domain", -1)),
    ])

def iter_level4_specs():
    return _emit("level_4", [
        ("Find the domain of f(x) = √(9 - x^2).", "[-3, 3]", ("circle_top", "domain", 3)),
        ("Find the range of f(x) = √(9 - x^2).", "[0, 3]", ("circle_top", "range", 3)),
        ("Find the range of f(x) = -√(16 - x^2).", "[-4, 0]", ("circle_bottom", "range", 4)),
    ])

def iter_level5_specs():
    return _emit("level_5", [
        ("Find the domain of f(x) = ln(x - 5).", "(5, ∞)", ("log", "domain", 5)),
        ("Find the range of f(x) = ln(x - 5).", "(-∞, ∞)", ("log", "range", 5)),
        ("Find the domain of f(x) = (x + 1)/(x^2 - 9).", "(-∞, -3) ∪ (-3, 3) ∪ (3, ∞)", ("rational_quad", "domain", -3, 3)),
    ])
