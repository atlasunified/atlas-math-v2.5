...
MODULE_INFO = {
    "module_id": "precalculus.vectors_basic_operations",
    "name": "Vectors Basic Operations",
    "topic": "precalculus",
...
INSTRUCTIONS = [
    "Compute the vector operation: {problem}",
    "Find the requested vector result: {problem}",
    "Work with the vector components: {problem}",
]
...
def iter_level1_specs():
    return _emit("level_1", [
        ("add", ((2,3),(4,-1)), "Find <2, 3> + <4, -1>.", "<6, 2>"),
        ("subtract", ((5,7),(1,2)), "Find <5, 7> - <1, 2>.", "<4, 5>"),
        ("scalar_mult", (3,(2,-4)), "Find 3<2, -4>.", "<6, -12>"),
    ])

def iter_level2_specs():
    return _emit("level_2", [
        ("magnitude", ((3,4),), "Find the magnitude of <3, 4>.", "5"),
        ("magnitude", ((-8,6),), "Find the magnitude of <-8, 6>.", "10"),
        ("component_from_points", ((1,2),(6,5)), "Find the vector from (1, 2) to (6, 5).", "<5, 3>"),
    ])

def iter_level3_specs():
    return _emit("level_3", [
        ("unit_vector", ((3,4),), "Find the unit vector in the direction of <3, 4>.", "<3/5, 4/5>"),
        ("combine", (2,(1,-3),-1,(4,2)), "Find 2<1, -3> - <4, 2>.", "<-2, -8>"),
        ("parallel_check", ((2,4),(-1,-2)), "Are <2, 4> and <-1, -2> parallel?", "yes"),
    ])

def iter_level4_specs():
    return _emit("level_4", [
        ("resultant", ((3,1),(2,5),(-4,2)), "Find <3, 1> + <2, 5> + <-4, 2>.", "<1, 8>"),
        ("distance_via_vector", ((-1,2),(5,-6)), "Use vectors to find the distance between (-1, 2) and (5, -6).", "10"),
        ("linear_combo", (2,(3,-1),3,(-2,4)), "Find 2<3, -1> + 3<-2, 4>.", "<0, 10>"),
    ])

def iter_level5_specs():
    return _emit("level_5", [
        ("solve_unknown", ((2,-1),(5,8)), "Find <a, b> if 3<a, b> = <6, -3>.", "<2, -1>"),
        ("midpoint_vector", ((-2,7),(4,-1)), "Find the midpoint of the segment from (-2, 7) to (4, -1).", "(1, 3)"),
        ("basis_combo", (5,-2), "Write <5, -2> as a linear combination of i and j.", "5i - 2j"),
    ])
